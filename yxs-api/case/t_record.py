...
class Record(unittest.TestCase):
    ...
    def test_rihuo(self):
        ...
        headers['type'] = "00"
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_rihuo)
    ...
    def test_yuedujilu(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = "10"
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_yuedujilu)
        # 所有的yuedujilu的接口
        # for key,value in reqData.items():
    ...
    def test_shudanbaoguang(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = '11'
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_shudanbaoguang)
    ...
    def test_shujixiangqingye(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = '12'
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_shujixiangqingye)
    ...
    def test_shudanhuanyihuan(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = '13'
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_shudanhuanyihuan)
    ...
    def test_jiarushujiaxinxi(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = '14'
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_jiarushujiaxinxi)
    ...
    def test_appfenxiang(self):
        ...
        headers['time'] = str(time.time()).split('.')[0]
        headers['type'] = '02'
        to_requests(url=url,method='post',reqData=reqData,headers=headers,reqPath=reqPath,sheetindex=0,func=self.test_appfenxiang)
